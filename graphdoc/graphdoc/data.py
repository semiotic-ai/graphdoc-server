...
class DataHelper:
    ...
    # DSPy Data Helper
    ######################
    def _create_graph_doc_example_trainset(self, dataset: Dataset) -> List[Example]: # TODO: we should really name this better
        """
    ...
    def _create_doc_generator_example_trainset(self, dataset: Dataset) -> List[Example]: # TODO: we should really name this better
        """
