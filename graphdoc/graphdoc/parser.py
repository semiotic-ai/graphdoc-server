...
class Parser:
    ...
    def format_graphdoc_quality_response(self, data):
        """
        ...
        # Split the reasoning response into chunks of approximately 50 characters
        chunk_size = 125
        reasoning_chunks = []
        current_chunk = ""
    ...
    def folders_for_responses(self, results): 
        ...
        """
        correct_folder = Path("correct_responses")
