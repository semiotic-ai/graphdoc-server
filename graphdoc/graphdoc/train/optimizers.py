...
def optimizer_class(optimizer_type: str, optimizer_kwargs: Dict[str, Any]):
    if optimizer_type == "miprov2":
        ...
        # ...
        return dspy.MIPROv2(**_optimizer_kwargs_filter(init_signature=inspect.signature(dspy.MIPROv2.__init__), optimizer_kwargs=optimizer_kwargs))
    else:
...
def optimizer_compile(optimizer_type: str, optimizer_kwargs: Dict[str, Any]):
    ...
    return optimizer.compile(**_optimizer_kwargs_filter(init_signature=inspect.signature(optimizer.compile), optimizer_kwargs=optimizer_kwargs))